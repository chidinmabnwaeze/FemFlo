  ...
  return (
    <>
      ...
      <main className="">
        <section className="hero w-full bg-soft-color relative z-10 mx-auto px-6 flex justify-between items-center h-screen">
          <div className="content flex justify-between items-center w-full max-w-7xl mx-auto">
            <div className=" max-w-2xl">
              ...
              <button className="rounded p-4 px-6 mt-8 bg-primary-color text-white font-semibold hover:bg-secondary-color transition">
                Get It On PlayStore
              </button>
            </div>
            <div>
        ...
        <section className="relative z-10 mt-5 bg-primary-color backdrop-blur-md p-30 rounded-2xl max-w-7xl mx-auto border border-white/40">
